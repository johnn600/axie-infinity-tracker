...
async function wait_graph_data(){
  var graph_data = await eel.line_graph_data()();
...
//wait_graph_data();
(async () => {
  var data_line_graph = await wait_graph_data();
  
  console.log("data_line_graph typeof: " + typeof data_line_graph)
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      // need dapat maadto dri ang value from database > python > string
